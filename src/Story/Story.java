...
//##########################   TRAINING MIT KRILLIN  ###################################################################################
        ...
        dialog.addMessage(
            "Klar doch! Wir haben seit dem Tunrier nicht mehr /n gegeneinander gekämpft!", spieler,
            null);
        ...
        dialog.addMessage(
            "Ich werde den Oberteufel endlich rächen..... /n und danach sind die anderen dran! ",
            gegner, null);
        ...
        dialog.addMessage(
            "Hier scheint es ja doch noch Krieger zu geben... /n ..aber ihre Kampfkraft ist trotzdem mickrig. ",
            FighterData.VEGETA, null);
        dialog.addMessage("Pass auf Tenshinhan, die Typen sehen stark aus!", FighterData.YAMCHA,
            null);
        dialog.addMessage("Ich muss sie aufhalten Yamchu! /n Sonst werden wir alle sterben!",
            gegner, null);
        ...
        dialog.addMessage(
            "Schon keine Motivation mehr? /n Und ich verrate euch was, Vegeta ist noch viel /n stärker als ich! Hahahaa!",
            spieler, null);
        dialog.addMessage("Warte nur bis Son Goku kommt!", FighterData.KRILLIN, null);
        dialog.addMessage(
            "Nicht vordrängeln, du bist als nächster dran. /n Aber vorher der grüne Kerl!", spieler,
            null);
        ...
        dialog.addMessage("Es ist Son Goku!", FighterData.YAMCHA,
            new DialogAktion(0, DialogAktion.EINFLIEGEN, 0));
        ...
        dialog.addMessage("Vegeta! Wie hoch ist seine Kampfkraft?", gegner,
            new DialogAktion(0, 0, 15));
        dialog.addMessage("Sie steigt immer höher....! Sie ist....", FighterData.VEGETA,
            new DialogAktion(0, 0, 15));
        dialog.addMessage("ITS OVER 9000!!!!!!!!!!!!!!!", FighterData.VEGETA,
            new DialogAktion(1, 2, 21));
        battle.setDialog(dialog);
        battle.setIcon(5);
        ...
        dialog.addMessage(
            "Hallo Du! Mein Name ist Krillin und wir /n sind nach Namek gekommen um die Dragonballs /n zu finden.",
            spieler, null);
        ...
        dialog.addMessage("Hohoho euch helfen...  /n das wird Meister Freezer gefallen!", gegner,
            null);
        dialog.addMessage("Freezer?", spieler, null);
        dialog.addMessage(
            "Wenn ich mit dir fertig bin wirst du ihn noch früh /n genug kennenlernen! Und jetzt bleib schön still!",
            gegner, null);
        battle.setDialog(dialog);
        battle.setIcon(9);
        ...
        dialog = new Dialog();
        dialog.addMessage(
            "Das ist also Namek.. /n Freezers Leute reden zu viel, die Dragonballs /n sind schon so gut wie mein.",
            spieler, null);
        dialog.addMessage("Hohoho wenn das nicht Vegeta ist!", gegner, null);
        dialog.addMessage(
            "Recoome aus dem Ginyu Sonderkomando! /n Das ist Freezers Spezieleinheit! ", spieler,
            null);
        dialog.addMessage("Freezer weiß bescheid von deinem kleinen Ausflug.", gegner, null);
        dialog.addMessage("Grrr.. ", spieler, null);
        dialog.addMessage("Ich bin extra gekommen um deine witzigen Pläne /n zunichte zu machen.",
            gegner, null);
        ...
        battle.setTeams(te);
        dialog = new Dialog();
        dialog.addMessage("Recoome und Guldo haben mir von euch erzählt...", FighterData.GINYU,
            null);
        dialog.addMessage("Hahaha deine Krieger sind Waschlappen!", gegner, null);
        dialog.addMessage(
            "Ich hab extra für dich mit nur der halben Kraft /n gekmäpft! Du darfst doch auch mal gewinnen. ",
            FighterData.RECOOME, null);
        ...
        dialog.addMessage("Ja Super! Einer bekommt den kleinen und der andere /n den Zwiebelkopf!",
            spieler, null);
        dialog.addMessage("Also gut... Schere ...Stein...Papier!", FighterData.GINYU, null);
        dialog.addMessage("Juhu! Ich bin dran!", spieler, null);
        dialog.addMessage(
            "Oh Vegeta du hast ganz schön Glück! /n Jetzt zeig ich dir meine wahre Power! ",
            FighterData.RECOOME, null);
        dialog.addMessage(
            "Du Kleiner, wir müssen zusammen kämpfen /n sonst haben wir keine Chance!", gegner,
            null);
        ...
        dialog.addMessage("Sie haben doch die Wahrheit gesagt... /n Sie sind einfach zu stark... ",
            FighterData.VEGETA, null);
        dialog.addMessage("Schon den Mut verloren Vegeta? /n Jetzt mache ich dich für immer kalt!",
            gegner, null);
        ...
        dialog.addMessage("Son Goku!!! /n Du musst uns helfen wir können nicht gewinnen!",
            FighterData.KRILLIN, null);
        dialog.addMessage("Pff der schon wieder... ", FighterData.VEGETA, null);
        dialog.addMessage(
            "Oh noch ein Kamerad zum sterben! /n Meister Freezer hat langsam genug von euch!",
            gegner, null);
        dialog.addMessage(
            "Ich bin nicht gekommen um zu sterben sondern /n um meine Freunde zu retten! ", spieler,
            null);
        dialog.addMessage(
            "Hahahah weißt du nicht wer wir sind? /n Mit deiner mickrigen Kampfkraft kannst du uns /n nichts anhaben!",
            FighterData.BURTER, null);
        ...
        dialog.addMessage(
            "DDDDas ist irgendein Trick oder so! /n Ich bin doch der schnellste im Universum!",
            FighterData.BURTER, null);
        ...
        dialog.addMessage(
            "Hmm.. Du scheinst echt stark zu sein. /n Wenn du willst darfst du meinem Team beitreten.",
            spieler, null);
        ...
        dialog.addMessage(
            "Kakarott ist ein friedlicher Sayajin./n Er wird euerer Truppe niemals beitreten!  /n Ich hab es selber kaum glauben können.",
            FighterData.VEGETA, null);
        dialog.addMessage(
            "Schweig du Versager! /n Ich wusste garnicht dass Prinz Vegeta /n Hilfe von Unterklasse Kriegern braucht!",
            spieler, null);
        ...
        dialog.addMessage(
            "Grrr.. zu zweit sieht die Pose beknackt aus. /n Das werdet ihr mir büßen!",
            FighterData.GINYU, null);
        dialog.addMessage("Jetzt ist der Captain sauer, spricht euer /n letztes Gebot! Hahahaha! ",
            FighterData.JEECE, null);
        ...
        dialog.addMessage(
            "Diese Stärke.. also sind die Gerüchte doch wahr! /n Ich glaube selbst du hast keine Chance /n gegen ihn Son Goku...",
            FighterData.VEGETA, null);
        ...
        dialog.addMessage("Hahah ihr habt verloren! /n Kakarott wird euch fertig machen!",
            FighterData.VEGETA, null);
        dialog.addMessage(
            "Das glaubst auch nur du... /n Auf diesen Moment habe ich schon immer gewartet!",
            spieler, null);
        dialog.addMessage("Ich weiß was der Captain vorhat! /n Ihr seid schon so gut wie tot!",
            FighterData.JEECE, null);
        dialog.addMessage("Das hoffe ich doch, sonst wird der Kampf /n ziemlich eintönig!", gegner,
            null);
        ...
        dialog.addMessage(
            "Urggh.. Ich kann mich kaum bewegen... /n Er hat seinen Körper absichtlich verletzt.",
            FighterData.GINYU, null);
        dialog.addMessage(
            "Vielen Dank für deine Energie! /n Mit diesem Körper bin ich unbesiegbar!", gegner,
            null);
        dialog.addMessage("Was? Son Goku steckt jetzt in Ginyus Körper?", FighterData.KRILLIN,
            null);
        dialog.addMessage("Ja Krillin.. ich kann euch nicht mehr helfen... /n Urghhh...",
            FighterData.GINYU, null);
        dialog.addMessage("Son Goku!!!", FighterData.KRILLIN,
            new DialogAktion(2, DialogAktion.KILLFIGHTER, 0));
        dialog.addMessage("Hahaha jetzt mach ich euch fertig!", gegner, null);
        dialog.addMessage(
            "Urggh... glaub ja nicht du kannst meine Energie /n richtig kontrollieren... ",
            FighterData.GINYU, null);
        dialog.addMessage(
            "Jetzt bin ich wohl grefragt! /n Ich wollte schon immer Kakarott schlagen!", spieler,
            null);
        ...
        dialog.addMessage(
            "Du hast Gokus Körper übel zugerichtet. /n Zum Glück hat er seinen Körper wieder und /n Ginyu hüpft hier irgendwo als Frosch rum.",
            FighterData.KRILLIN, null);
        dialog.addMessage(
            "Ja.. das war gerade noch rechtzeitig, /n sonst hätte er jetzt Vegetas Körper.",
            FighterData.GOKU, null);
        dialog.addMessage(
            "Hmm Freezer wird sicher bald erfahren dass /n das Ginyu Komando verschwunden ist.",
            FighterData.VEGETA, null);
        dialog.addMessage("Besser wir bringen dich gleich in den /n Heilapparat Goku.",
            FighterData.KRILLIN, null);
        dialog.addMessage("Ja macht bitte schnell... ", FighterData.GOKU, null);
        dialog.addMessage(
            "So das wäre geschafft. /n Ruh dich auch aus Kleiner wir bekommen sicher /n bald Besuch.",
            FighterData.VEGETA, null);
        dialog.addMessage("Ja wird wohl besser so sein...", FighterData.KRILLIN, null);
        dialog.addMessage("Da bist du also Vegeta!!!", spieler,
            new DialogAktion(0, DialogAktion.EINFLIEGEN, 0));
        dialog.addMessage("Freezer!", FighterData.VEGETA, null);
        dialog.addMessage(
            "Hast mich wohl nicht so früh erwartet... /n Das ganze Komando wurde ausgelöscht! /n Ich kann nicht glauben dass ihr dafür /n verwantwortlich seid...!",
            spieler, null);
        dialog.addMessage("Unterschätze mich nicht Freezer!", FighterData.VEGETA, null);
        dialog.addMessage("Oh hab ich dir schonmal erzählt wie hoch meine /n Kampfkraft ist?",
            spieler, null);
        dialog.addMessage("Bei über 1.000.000 und mit jeder Entwicklung /n verdoppelt sie sich. ",
            spieler, null);
        dialog.addMessage("Uhh... red keinen Unsinn!", FighterData.VEGETA, null);
        dialog.addMessage(
            "Willst du etwa schon aufgeben? /n Wäre besser für dich ich machs auch schmerzlos.",
            spieler, null);
        dialog.addMessage(
            "Wenn wir ihn zusammen angreifen können wir es /n schaffen! Schnell Kleiner!",
            FighterData.VEGETA, null);
        ...
        dialog.addMessage("Wie kann er so stark sein.../n Ich versteh das nicht..",
            FighterData.VEGETA, null);
        dialog.addMessage(
            "Du ödest mich langsam an... /n Ich hätte gründlicher vorgehen müssen als ich euch /n alle auslöschte.",
            gegner, null);
        dialog.addMessage("Du wirst irgendwann dafür bezahlen!", FighterData.VEGETA, null);
        dialog.addMessage("Was sollen wir jetzt tun? /n Wir können ihm nichts ausrichten!",
            FighterData.KRILLIN, null);
        dialog.addMessage(
            "Es dauert noch bis Son Goku geheilt ist. /n Solange müssen wir durchhalten!",
            FighterData.VEGETA, null);
        dialog.addMessage("Hallo Krillin!", spieler,
            new DialogAktion(0, DialogAktion.EINFLIEGEN, 0));
        dialog.addMessage("Piccolo! Unser Wunsch hat funktioniert!", FighterData.KRILLIN, null);
        dialog.addMessage(
            "Der Namekianer strahlt eine gewaltige Energie aus. /n Seit wann ist der so stark? ",
            FighterData.VEGETA, null);
        dialog.addMessage(
            "Ich habe mich mit dem letzten Krieger fusioniert /n um Freezer zu schlagen und alle Namekianer /n zu rächen!",
            spieler, null);
        ...
        dialog = new Dialog();
        dialog.addMessage(
            "Das war nicht schlecht für einen Namekianer... /n Sogar besser als Vegeta!", spieler,
            null);
        dialog.addMessage(
            "Er ist einfach zu stark... /n Ich habe mich überschätzt es tut mir Leid.",
            FighterData.PICCOLO, null);
        ...
        dialog.addMessage(
            "Immer höre ich nur Kakarott ... /n Sogar ein Namekianer ist jetzt stärker! /n Ich bin der Prinz der Sayajins das kann nicht sein!",
            gegner, new DialogAktion(1, 0, 15));
        ...
        dialog.addMessage(
            "Ich bin stärker wie nie zuvor und dein Untergang! /n Ich werde alle Sayajins rächen!",
            gegner, null);
        dialog.addMessage(
            "Ich hoffe das ist ein schlechter Scherz. /n Du weißt ich mag diese Geschichte nicht.",
            spieler, null);
        dialog.addMessage(
            "Ich sehe deine Furcht! Wie fühlt man sich wenn man /n von einer Geschichte besiegt wird?",
            gegner, null);
        dialog.addMessage(
            "Jetzt reichts! Ich stopf dir dein freches Mundwerk! /n Ich vollende nun was ich damals angefangen habe! /n Stirb!!!!",
            spieler, null);
        ...
        dialog.addMessage("Das kann nicht sein! /n Ich muss ihn doch besiegen!", FighterData.VEGETA,
            null);
        dialog.addMessage(
            "Ich habe es langsam satt immer gegen Versager /n zu kämpfen. Ihr nervt mich gewaltig!",
            gegner, null);
        ...
        dialog.addMessage("Das tat gut. Ich bin bereit Leute!", spieler,
            new DialogAktion(0, DialogAktion.EINFLIEGEN, 0));
        ...
        dialog.addMessage("Das ist Kakarott! /n Er wird dich besiegen und uns rächen!",
            FighterData.VEGETA, null);
        dialog.addMessage("Ich mag so Leute nicht die denken sie /n können mich besiegen!", gegner,
            null);
        dialog.addMessage("Hast du Vegeta und Krillin so zugerichtet?", spieler, null);
        dialog.addMessage("Ja klar, und der Namekianer da drüben geht auch /n auf mein Konto!",
            gegner, null);
        dialog.addMessage("Grrr.. das wirst du bezahlen!", spieler, null);
        dialog.addMessage(
            "Haha Freezer das ist dein Ende! /n Son Goku ist ein Super Sayajin geworden!",
            FighterData.VEGETA, null);
        dialog.addMessage("Wirst du endlich aufhören mit deiner Geschichte!", gegner, null);
        dialog.addMessage("Du wirst verlieren Freezer er wird /n dich besiegen!",
            FighterData.VEGETA, null);
        dialog.addMessage("Wenn ich was noch mehr hasse als Versager... /n dann sind es Schwätzer!",
            gegner, null);
        ...
        dialog.addMessage(
            "Arggg... Kakarott.../n ...ich muss dir noch was über deine Herkunft erzählen... /n Du stammst vom Planeten Vegeta so wie alle Sayajins..",
            FighterData.VEGETA, null);
        dialog.addMessage("Hört der niemals auf zu quaseln?", gegner, null);
        dialog.addMessage(
            "Unsere Heimat wurde nicht von einem Asteroiden zerstört... /n sondern von Freezer!",
            FighterData.VEGETA, null);
        dialog.addMessage("Oh wer hätte das gedacht...", gegner, null);
        dialog.addMessage(
            "Bitte verpsrich mir dass du alle Sayajins rächst.../n und Freezer besiegst!",
            FighterData.VEGETA, null);
        dialog.addMessage(
            "Vegeta.... /n Das ist das erste mal dass du mich etwas bittest. /n Du hast zwar viele schreckliche Dinge getan.. /n aber du warts ein stolzer Krieger.",
            spieler, null);
        dialog.addMessage(
            "Bitte geb mir etwas von deinem Stolz /n Damit ich unser Volk rächen kann!", spieler,
            null);
        ...
        battle.setTeams(te);
        dialog = new Dialog();
        dialog.addMessage("Du hast Freezer besiegt! /n Die Genkidama hat ihn vernichtet!",
            FighterData.KRILLIN, null);
        ...
        dialog.addMessage("Hahaha habt ihr geglaubt ich wäre schon besiegt?", gegner,
            new DialogAktion(1, DialogAktion.EINFLIEGEN, 0));
        dialog.addMessage("Freezer!!!", spieler, null);
        dialog.addMessage(
            "Jetzt ist Schluss mit lustig! /n Ich werde einen nach dem anderen umlegen!", gegner,
            null);
        ...
        dialog.addMessage("Er war mein bester Freund und kann nicht mehr /n wiedererweckt werden!",
            spieler, new DialogAktion(0, 0, 15));
        dialog.addMessage("Freezer dafür wirst du bezahlen!!!!!", spieler,
            new DialogAktion(0, 0, 15));
        ...
        dialog.addMessage("Yahhhhhhhhhhhhhh!!!!", spieler,
            new DialogAktion(0, DialogAktion.CHANGEID, FighterData.SSJGOKU));
        dialog.addMessage("Wwwwer bist du???", gegner, null);

        dialog.addMessage(
            "Ich bin der Super Sayajin Son Goku und werde /n dich ein für allemal vernichten!",
            spieler, null);
        battle.setDialog(dialog);
        battle.setIcon(7);
        ...
        dialog.addMessage("Nein das kann nicht sein! /n Ich bin der Stärkste im ganzen Universum!",
            gegner, null);
        ...
        dialog.addMessage(
            "Pump so viel du willst es wird dir nichts nützen. /n Ich bin stärker als du, akzeptier es. ",
            spieler, null);
        dialog.addMessage("Niemals ich bin der Stärkste!!! ", gegner, new DialogAktion(1, 0, 15));
        gegner = FighterData.FREEZER100;
        dialog.addMessage("Yahhhhhh!!!", gegner,
            new DialogAktion(1, DialogAktion.CHANGEID, FighterData.FREEZER100));

        dialog.addMessage("Haha nun hast du es mit 100% meiner Kraft zu tun!", gegner, null);
        dialog.addMessage(
            "Kraft allein nützt dir nichts! /n Ich bin schneller und immer noch stärker als du!",
            spieler, null);
        ...
        dialog.addMessage(
            "Wer bist du überhaupt? /n Und warum kannst du dich auch in einen /n Super Sayajin verwandeln?",
            spieler, null);
        dialog.addMessage(
            "Du wirst mir sicher kaum glauben können... /n Ich bin Trunks und komme aus der Zukunft. /n Vegeta ist mein Vater...",
            gegner, null);
        ...
        dialog.addMessage(
            "Bulma, meine Mutter hat in der Zukunft eine /n Zeitmaschine gebaut.  Mit dieser bin ich in die /n Vergangenheit geflogen  um euch zu warnen.",
            gegner, null);
        dialog.addMessage("Du hast die Gefahr gerade doch beseitigt?", spieler, null);
        dialog.addMessage("Nein das war nur ein Witz gegen dass /n was euch bevor steht!", gegner,
            null);
        dialog.addMessage(
            "Es werden Cyborgs kommen mit grenzenloser Energie /n stärker als ein Super Sayajin!",
            gegner, null);
        dialog.addMessage(
            "Und das ist noch nicht alles du wirst schwer krank. /n Ich habe extra eine Medizin mitgebracht, /n in meiner Zeit bist du schon gestorben...",
            gegner, null);
        dialog.addMessage("Das klingt echt nicht gut!", spieler, null);
        dialog.addMessage(
            "Ja deshalb bin ich gekommen um euch zu helfen. /n Aber vorher möchte ich gerne sehen was drauf hast.",
            gegner, null);
        dialog.addMessage("Kannst du dich auch verwandeln?", gegner, null);
        dialog.addMessage("Ja genau so wie du! Sieh her..", spieler, null);
        spieler = FighterData.SSJGOKU;
        dialog.addMessage("Yahhhhhhh!", spieler,
            new DialogAktion(0, DialogAktion.CHANGEID, spieler));
        ...
        dialog = new Dialog();
        dialog.addMessage("Endlich ist es soweit! /n Die Cyborgs sind gleich fertig!", gegner,
            null);
        dialog.addMessage("Hmm? Woher kam das Geräusch?", gegner, null);
        dialog.addMessage("Hab ich dich gefunden!", spieler,
            new DialogAktion(0, DialogAktion.EINFLIEGEN, 0));
        dialog.addMessage("Oha! Wer bist denn du? /n Und wie hast du mein Labor gefunden?", gegner,
            null);
        dialog.addMessage("Ich bin gekommen um deine finsteren Pläne zu stoppen!", spieler, null);
        dialog.addMessage(
            "Hahaha da bist du leider schon zu spät./n Die Cyborgs werden jeden Moment auferstehen!",
            gegner, null);
        ...
        dialog.addMessage("Das sind C18 und C17! /n Sie haben euch alle getötet in meiner Zeit!",
            FighterData.TRUNKS, null);
        ...
        dialog.addMessage("Mit jedem absorbierten Mensch werde ich mächtiger!", spieler,
            new DialogAktion(0, DialogAktion.EINFLIEGEN, 0));
        dialog.addMessage("Das muss Cell sein!", gegner,
            new DialogAktion(1, DialogAktion.EINFLIEGEN, 0));
        dialog.addMessage("Oha wer bist denn du?", spieler, null);
        dialog.addMessage(
            "Du bist doch das Laborprojekt aus der Zukunft /n von diesem verrückten Professor!",
            gegner, null);
