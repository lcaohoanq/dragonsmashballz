...
public abstract class FighterKIMoves extends KIMethodes{
	 ...
	 * Steuert alle Abl�ufe, verwaltet Stellenwerte und �ndert aktuelle
	...
	/**
	 * �berpr�ft ob feindliche Angriffe in der N�he sind.
	 * F�hrt automatisch zu einem MoveAway() von der Angriffsquelle 
	 */
	...
	/**
	 * K�mpfer von einer Angriffsquelle wegbewegen.
	 * float[] speed wird als Bewegungsgeschwindigkeit
	 * der Attacke �bergeben, um ein genaueres Ausweichen
	 * zu erm�glichen
	 * 
	 * Achtung: �berpr�ft nicht ob genug KI zum Sprinten
	 * �brig ist. F�hrt automatisch zum Verteidigen wenn
	 * kein KI mehr �brig ist (Selbststeuerung des Fighters)
	 */
	 ...
	 * Wenn zu wenig Ki, wird Ki Laden ausgef�hrt.
	 * 
	 * Autoablauf:
	 * Wenn ein Gegner zu Nahe kommt, wird die
	 * Autoreaktion attackEscapeOrBlock() aufgerufen
	 ...
	 * wird der Ki-Load Befehl ausgef�hrt.
	 * 
	 * Autoablauf:
	 * Wenn ein Gegner zu Nahe kommt, wird die
	 * Autoreaktion attackEscapeOrBlock() aufgerufen
	 ...
	 * Bei zu wenig KI wird Ki-Load Befehl ausgef�hrt
	 * 
	 * 
	 * Autoablauf:
	 * Wenn ein Gegner zu Nahe kommt, wird die
	 ...
	 * 
	 * Autoablauf:
	 * Wenn kein Gegner in der N�he ist,
	 ...
	 * f�hrt zuf�llig nach Stellenwert zu
	...
	/**
	 * Gibt n�chste Aktion-ID zur�ck,
	 * abh�ngig vom Stellenwert
	 */
