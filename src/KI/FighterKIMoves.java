...
public abstract class FighterKIMoves extends KIMethodes {
    ...
    /**
     * Der KI Taktgebervorgang. Steuert alle Abl�ufe, verwaltet Stellenwerte und �ndert aktuelle
    ...
    protected void auto(Attack[] attacks, int id) {
        ...
        if (aktiontimer > 0) {
            ...
            doAktion = getAktion();
            aktiontimer =
                (int) (Math.random() * aktionlength[doAktion] + 1) + aktionlength[doAktion] / 3;
    ...
    /**
     * �berpr�ft ob feindliche Angriffe in der N�he sind. F�hrt automatisch zu einem MoveAway() von
     * der Angriffsquelle
     */
    ...
    /**
     * K�mpfer von einer Angriffsquelle wegbewegen. float[] speed wird als Bewegungsgeschwindigkeit
     * der Attacke �bergeben, um ein genaueres Ausweichen zu erm�glichen
     * <p>
     * Achtung: �berpr�ft nicht ob genug KI zum Sprinten �brig ist. F�hrt automatisch zum
     * Verteidigen wenn kein KI mehr �brig ist (Selbststeuerung des Fighters)
     */
    ...
    /**
     * F�hrt die aktuelle Aktion aus der Aktionskette aus
     */
    ...
    /**
     * Befehl zum Weiterentwickeln. Wenn genug KI zum weiterentwickeln vorhanden ist, entwickelt
     * sich der K�mpfer.
     * <p>
     * Autoablauf: Wenn ein Gegner zu Nahe kommt, wird die Autoreaktion attackEscapeOrBlock()
     * aufgerufen
     */
    ...
    /**
     * Befehl zum Abfeuern eines Ki-Angriffs. Wenn zu wenig Ki, wird Ki Laden ausgef�hrt.
     * <p>
     * Autoablauf: Wenn ein Gegner zu Nahe kommt, wird die Autoreaktion attackEscapeOrBlock()
     * aufgerufen
     */
    ...
    /**
     * Befehl zum PowerUP. Wenn nicht genug Ki vorhanden ist, wird der Ki-Load Befehl ausgef�hrt.
     * <p>
     * Autoablauf: Wenn ein Gegner zu Nahe kommt, wird die Autoreaktion attackEscapeOrBlock()
     * aufgerufen
     */
    ...
    /**
     * Befehl zum Einsetzen des Ultimativen Angriff. Bei zu wenig KI wird Ki-Load Befehl ausgef�hrt
     * <p>
     * <p>
     * Autoablauf: Wenn ein Gegner zu Nahe kommt, wird die Autoreaktion attackEscapeOrBlock()
     * aufgerufen
    ...
    /**
     * Befehl zum Einsetzen des Special Angriff. Bei zu wenig KI wird Ki-Load Befehl ausgef�hrt
     * <p>
     * <p>
     * Autoablauf: Wenn ein Gegner zu Nahe kommt, wird die Autoreaktion attackEscapeOrBlock()
     * aufgerufen
     ...
     * <p>
     * <p>
     * Autoablauf: Wenn kein Gegner in der N�he ist, wird newRandomMove() aufgerufen
     */
     ...
     * <p>
     * <p>
     * Autoablauf: Wenn die Ki voll ist, wird newRandomMove() aufgerufen Wenn Gegner zu nahe kommen,
     * wird attackEscapeOrBlock() aufgerufen.
     */
     ...
     * <p>
     * Autoablauf: Wenn Gegner zu weit entfernt ist, wird bewegeZuGegner() augerufen Wenn in Gegner
     * steht, wird eine FLuchtaktion ausgef�hrt
     */
    ...
    /**
     * Meist wenn Gegner zu Nahe sind, f�hrt zuf�llig nach Stellenwert zu folgenden 3 verschiedenen
     * Reaktionen:
     * <p>
     * -Angreifen -Verteidigen -Fl�chten
     */
    ...
    /**
     * Gibt n�chste Aktion-ID zur�ck, abh�ngig vom Stellenwert
     */
