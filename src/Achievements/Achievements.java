...
public class Achievements implements Serializable {
    ...
    public Achievements() {
        ...
        tasks.add(
            new Task("Cyborg Power", "Win without Healing C-18 against Vegeta and Piccolo", 20, 1));
        ...
        tasks.add(
            new Task("Goku is the Greatest", "Watch Goku winning agianst Vegeta 1v1", 10, true, 2));
        tasks.add(
            new Task("Vegeta finally wins", "Watch Vegeta winning against Goku 1v1", 10, true, 2));
        tasks.add(new Task("Amazing Battle", "Fight 3 Minutes long", 20, 2));
        tasks.add(
            new Task("Full Recovery", "Heal your full Health with Buu's passive Regeneration", 10,
                2));
        tasks.add(new Task("Super Saiyan", "Transform into Super Saiyan", 10, 2));
        tasks.add(
            new Task("Cyborg Master", "Fire 10 Special Techniques in one Game with a Cyborg", 10,
                2));
        ...
        tasks.add(
            new Task("This is Madness", "Fire a Spirit Bomb loaded with 10 Power Lightnings", 20,
                2));
        ...
        tasks.add(
            new Task("Random Party", "Start a Game with 10 random Players and a random Map", 10,
                true, 2));
        //Special
