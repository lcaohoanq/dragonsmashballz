...
public class OptionMenu extends MenuData {
    ...
    private final String[] options = {"Graphic Settings", "resources.Music Settings", "Controls",
        "Gamespeed", "Help", "Back"};
        ...
        if (submenu == 0) {
            ...
            switch (m) {
                case 0: //Graphic settings
                    submenu = 1;
                    break;
                case 1: //resources.Music settings
                    submenu = 2;
                    break;
                case 2: //Controls
                    submenu = 3;
            ...
            switch (m) {
                case 0:
                    Main.setGroesse(!Main.settings.isFullscreen());
                    break;
                case 1:
                    Blood.switchBloodOn();
                    break;
                case 2:
                    ...
                    break;
                case 3:
                    Main.settings.switchKillMessage();
                    break;
                case 4:
                    submenu = 0;
                    break;
            ...
            gr[0] = "resources.Music: Off";
            if (Main.settings.playMusic()) {
                gr[0] = "resources.Music: On";
            }
            gr[1] = "Sound: Off";
            ...
            String[] help = {"Gameplay", "Item & Buildmenu", "Connecting Controller", "Settings",
                "Back"};
            if (shownr > -1) {
