...
public class ControlMenu extends MenuData {
        ...
        if (showpadnames) {
            ...
            switch (wahl) {
                case 0:
                    ...
                    break;
                case 1:
                    Main.controlsettings.newKeyboard();
                    break;
                case 2:
                    Main.controlsettings.newGamepad();
                    break;
            }
    ...
    public void paintFPS(Graphics g) {
        ...
        g.setFont(font2);
        g.drawString("Here you can adjust the frames-per-seconds if the game runs too slow or fast",
            220, 180);
        g.setColor(new Color(100, 100, 100));
        ...
        for (int i = 0; i < 25; i++) {
            ...
            g2d.setComposite(
                AlphaComposite.getInstance(AlphaComposite.SRC_OVER, ((float) i / 25f)));
