...
public class Tournament extends TournamentGame {
    ...
    //Stages
    private final Stage[] stages = {new StageKame(), new StagePlain(), new StageLookout(),
        new StageCity(), new StageNamek(), new StageCell(), new StageTimeChamber(),
        new StageSpace()};
    ...
    private int getFighterFromList(int i) {
        ...
        switch (i) {//Fighter
            case 0:
                switch (r) {
                    case 1:
                        id = FighterData.KRILLIN;
                        break;
                    case 2:
                        id = FighterData.YAMCHA;
                        break;
                    case 3:
                        id = FighterData.SSJGOTEN;
                        break;
                }
                break;
            case 1:
            ...
            case 2:
                switch (r) {
                    case 1:
                        id = FighterData.PICCOLO;
                        break;
                    case 2:
                        id = FighterData.TENSHINHAN;
                        break;
                    case 3:
                        id = FighterData.KAI;
                        break;
            ...
            case 3:
                switch (r) {
                    case 1:
                        id = FighterData.TRUNKS;
                        break;
                    case 2:
                        id = FighterData.IMPERFECTCELL;
                        break;
                    case 3:
                        id = FighterData.C17;
                        break;
            ...
            case 4:
                switch (r) {
                    case 1:
                        id = FighterData.FREEZER;
                        break;
                    case 2:
                        id = FighterData.GINYU;
                        break;
                    case 3:
                        id = FighterData.VEGETA;
                        break;
                }
                break;
            case 5:
            ...
            case 6:
                switch (r) {
                    case 1:
                        ...
                        break;
                    case 2:
                        id = FighterData.SSJ3GOTENKS;
                        break;
                    case 3:
                        id = FighterData.SSJ2GOKU;
                        break;
                }
                break;
            case 7:
                switch (r) {
                    case 1:
                        id = FighterData.BROLY;
                        break;
                    case 2:
                        id = FighterData.JANEMBA;
                        break;
                    case 3:
                        id = FighterData.BABYVEGETA;
                        break;
                }
                break;
        }
