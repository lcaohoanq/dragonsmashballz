...
public class UseItem {
    ...
    private int getAttributeID(int type) {
        ...
        int id = -1;
        switch (type) {
            case Effect.EFFECT_HEALTH:
                id = 2;
                break;
            case Effect.EFFECT_KILOAD:
                id = 6;
                break;
            case Effect.EFFECT_ATTACKSPEED:
                id = 7;
                break;
            case Effect.EFFECT_DEFENCE:
                id = 4;
                break;
            case Effect.EFFECT_SPEED:
                id = 5;
        }
        return id;
    }
    ...
    private int getDamageID(int type) {
        ...
        int id = -1;
        switch (type) {
            case Effect.EFFECT_STRENGTH:
                id = 0;
                break;
            case Effect.EFFECT_KIPOWER:
                id = 2;
                break;
            case Effect.EFFECT_SPECIAL:
                id = 3;
                break;
        }
        return id;
