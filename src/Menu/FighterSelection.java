...
public class FighterSelection extends MenuData {
    ...
    private final Stage[] stages = {new StagePlain(), new StageKame(), new StageCity(),
        new StageNamek(), new StageMountain(), new StageDesert(), new StageField(), new StageIce(),
        new StageTournament(), new StageKorin(), new StageIsland(), new StageLookout(),
        new StageTimeChamber(), new StageCityDestroyed(), new StageCell(), new StageKaioworld(),
        new StageSpace(), new StageSnow(), new StageNamekDestroyed(), new StageForrest(),
        new StageLabor(), new StageCastle(), new StageRandom()};


    public static int[] fighters = {FighterData.GOKU, FighterData.SSJGOKU, FighterData.SSJ2GOKU,
        FighterData.SSJ3GOKU, FighterData.SSJ4GOKU, FighterData.VEGETA, FighterData.SSJVEGETA,
        FighterData.SSJ2VEGETA, FighterData.SSJ4VEGETA, FighterData.VEGETO, FighterData.GOHANKID,
        FighterData.TEENGOHAN, FighterData.GOHANSSJ2, FighterData.GOHAN, FighterData.SSJSONGOHAN,
        FighterData.MYSTIGGOHAN, FighterData.TRUNKSFUTURE, FighterData.TRUNKS, FighterData.KRILLIN,
        FighterData.YAMCHA, FighterData.TENSHINHAN, FighterData.PICCOLO, FighterData.SSJGOTEN,
        FighterData.YOUNGTRUNKS, FighterData.GOTENKS, FighterData.SSJGOTENKS,
        FighterData.SSJ3GOTENKS
        , FighterData.UUB, FighterData.NAPPA, FighterData.GULDO, FighterData.RECOOME,
        FighterData.BURTER, FighterData.JEECE, FighterData.GINYU, FighterData.FREEZER,
        FighterData.FREEZER100, FighterData.DRGERO, FighterData.C16, FighterData.C17,
        FighterData.C18, FighterData.IMPERFECTCELL, FighterData.SCNDCELL, FighterData.CELL,
        FighterData.CELLSUPER, FighterData.CELLJR, FighterData.KAI, FighterData.PUIPUI,
        FighterData.DABURA, FighterData.FATBOO, FighterData.BOO, FighterData.BOOTENKS,
        FighterData.BOOHAN, FighterData.KIDBOO, FighterData.HERCULE, FighterData.BARDOCK
        , FighterData.COOLER, FighterData.METALCOOLER, FighterData.TAPION, FighterData.BROLY,
        FighterData.SSJ4BROLY, FighterData.C13, FighterData.SUPERC13, FighterData.JANEMBA,
        FighterData.BABYVEGETA, FighterData.GOKUSSJ5, FighterData.SQUID, FighterData.RANDOM};
    ...
    public int paintTeamButton(Graphics g, int x, int y, int wahl, int mx, int my) {
        ...
        for (int i = 0; i < teamselection.size() + pi; i++) {
            ...
            if (steuerungwahl) {
                if (i < teamselection.size()) {
                    g.drawImage(GameImages.multisteer[steuerung.get(i).getIconID()], x - 10, y + 20,
                        null);
            ...
            if (id < fighters.length) {
                ...
                if (fighters[id] == FighterData.RANDOM) {
                    ...
                    if (freefighters[fighters[id]]) {
                        g.drawImage(GameImages.fighterselection[fighters[id] + 2], (150 + x * 105),
                            y,
                            100,
                            100, null);
