...
public class Menu extends MenuData implements MouseListener, MouseMotionListener {
    ...
    private final String[] singleplayer = {"Story Mode", "Tournament", "World Tournament",
        "Training", "Watch Battle", "Back"};
    private final String[] multiplayer = {"Team Fight", "Tournament", "Show Network IP",
        "Join Network Battle", "Back"};
        ...
        if (playintro) {
            ...
            if (ZeniScreen.schowZeniScreen()) {
                ...
                if (mainmenu) {
                    ...
                    String[] ms = {"Singleplayer", "Multiplayer", "Profil", "Settings", "Credits",
                        "Exit"};
                    ...
                    if (!tourn) {
                        ...
                        if (submenu > 1 && submenu < 1.4
                            || submenu == 1.7)//Tournament,Power,Survival
                        {
                        ...
                        if (submenu == 1.8) {//World Tournament
                            selection.setMousePos(mx, my);
                            selection.setKlick(klickn);
                            klickn = 0;
                            ...
                            switch (m) {
                                ...
                                case 2:
                                    ...
                                    try {
                                        ...
                                        c.getLocalAddress();
                                        multiplayer[2] += InetAddress.getLocalHost()
                                            .getHostAddress();
                        ...
                        if (submenu >= 2.1 && submenu <= 2.5) {
                            ...
                            if (selection.wantGo()) {
                                ...
                                } else if (submenu == 2.5) {//network fight
