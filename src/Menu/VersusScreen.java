            ...
            if (storyFight) {
                ...
                if (fight.getFighterAmount() > 2) {
                    ...
                    for (int h = 0; h < player.length; h++) {
                        if (player[h] != null) {
                            ...
                            if (time > ((i) * 20) + 20) {
                                ...
                                g.drawImage(GameImages.multisteer[team.getSteuerung(i).getIconID()],
                                    x + 480, y + 20, null);
                            }
                            i++;
                        }
                    ...
                    if (time >= 200) {
                        ...
                        g.drawString(FighterData.getName(id1),
                            245 - fm.stringWidth(FighterData.getName(id1)) / 2, 435);
                        g.drawString(FighterData.getName(id2),
                            745 - fm.stringWidth(FighterData.getName(id2)) / 2, 435);
                    ...
                    g.drawImage(GameImages.fighterselection[id1 + 2], (250 - bild / 2),
                        (300 - bild / 2),
                        bild,
                        bild, null);
                    g.drawImage(GameImages.fighterselection[id2 + 2], (750 - bild / 2),
                        (300 - bild / 2),
                        bild,
                        bild, null);
