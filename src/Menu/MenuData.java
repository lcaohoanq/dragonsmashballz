...
public abstract class MenuData {
    ...
    protected int paintMenuHorz(Graphics g, String[] menu, int xp, int yp, int width, int height) {
        ...
        for (int i = 0; i < menu.length; i++) {
            ...
            if (x > xp + i * (width + 20) && x < xp + width + i * (width + 20) && y > (yp) && y < (
                yp + height)) {
    ...
    protected int paintLockedMenu(Graphics g, String[] menu, boolean[] locked, int xp, int yp,
    ...
    protected int paintHiddenMenu(Graphics g, String[] menu, boolean[] locked, int xp, int yp,
        int width, int height) {
        int choice = -1;
        g.setFont(font);
    ...
    protected int paintSMenu(Graphics g, String[] menu, int xp, int yp, int width, int height,
        int wahl) {
        int choice = -1;
        g.setFont(font2);
    ...
    protected void paintMenu(Graphics g, String[] menu, int xp, int yp, int width, int height,
        int select) {
        int choice = -1;
        g.setFont(font);
