...
public class Sound {
    ...
    public Sound() {
        ...
        for (int i = 0; i < sounds.length; i++) {
            sounds[i] = loadSound("resources/Music/FX/s" + i + ".wav");
        }
        ...
        System.out.println("Load resources.Music");
        Main.LOADING = "Loading resources.Music";
        try {
            music.add(new OggClip("resources/Music/menu.ogg"));

            music.add(new OggClip("resources/Music/selection.ogg"));
            music.add(new OggClip("resources/Music/Credits.ogg"));
            music.add(new OggClip("resources/Music/intro.ogg"));

            for (int i = 0; i < 7; i++) {
                music.add(new OggClip("resources/Music/battle" + i + ".ogg"));
            }
            System.out.println("Load additional resources.Music");
            Main.LOADING = "Loading additional resources.Music";
            ...
            if (fileList != null) {
                for (int i = 0; i < fileList.length; i++) {
                    ...
                    if (f.getName().toLowerCase().endsWith(".ogg")) {
                        ...
                        System.out.println(
                            "Found additional Battle resources.Music: " + f.getName());
                    }
                }
            }
    ...
    public void playSound(int nr,
        boolean clear) // nr: soundnummer  clear: wenn false nur abspielen wenn sound gerade nicht abgespielt wird
    {
        if (playSounds) {
            if (clear) {
        ...
        for (int i = 0; i < Main.fighteranz; i++) {
            ...
            switch (i) {
                ...
                case 13:
                    ordner = "Android18";
                    break;
                case FighterData.IMPERFECTCELL:
                    ordner = "ImperfectCell";
                    break;
                case FighterData.CELLJR:
                    ordner = "CellJR";
                    break;
                case FighterData.C17:
                    ordner = "Android17";
                    break;
                case FighterData.C16:
                    ordner = "Android16";
                    break;
                case FighterData.GOTENKS:
                    ordner = "Gotenks";
                    break;
                case FighterData.SSJGOTENKS:
                    ordner = "Gotenks";
                    break;
                case FighterData.FATBOO:
                    ordner = "FatBoo";
                    break;
                case FighterData.SCNDCELL:
                    ordner = "Cell";
                    break;
                case FighterData.SSJVEGETA:
                    ordner = "Vegeta";
                    break;
                case FighterData.SSJ4VEGETA:
                    ordner = "SSJVegeta";
                    break;
                case FighterData.KIDBOO:
                    ordner = "KidBuu";
                    break;
                case FighterData.SSJ3GOKU:
                    ordner = "SSJGoku";
                    break;
                case FighterData.SSJ2GOKU:
                    ordner = "SSJGoku";
                    break;
                case FighterData.SSJ4GOKU:
                    ordner = "SSJGoku";
                    break;
                case FighterData.GOKUSSJ5:
                    ordner = "SSJGoku";
                    break;
                case FighterData.FREEZER100:
                    ordner = "Frieza";
                    break;
                case FighterData.BROLY:
                    ordner = "Broly";
                    break;
                case FighterData.SSJ4BROLY:
                    ordner = "Broly";
                    break;
                case FighterData.SSJSONGOHAN:
                    ordner = "MysticGohan";
                    break;
                case FighterData.GOHAN:
                    ordner = "MysticGohan";
                    break;
                case FighterData.YAMCHA:
                    ordner = "Yamcha";
                    break;
                case FighterData.KRILLIN:
                    ordner = "Krillin";
                    break;
                case FighterData.SQUID:
                    ordner = "Squid";
                    break;
                case FighterData.JEECE:
                    ordner = "Jeice";
                    break;
                case FighterData.TENSHINHAN:
                    ordner = "Tien";
                    break;
                case FighterData.VEGETO:
                    ordner = "Vegito";
                    break;
                case FighterData.SSJGOTEN:
                    ordner = "Goten";
                    break;
                case FighterData.YOUNGTRUNKS:
                    ordner = "KidTrunks";
                    break;
                case FighterData.UUB:
                    ordner = "Uub";
                    break;
                case FighterData.NAPPA:
                    ordner = "Nappa";
                    break;
                case FighterData.GULDO:
                    ordner = "Guldo";
                    break;
                case FighterData.RECOOME:
                    ordner = "Recoome";
                    break;
                case FighterData.BURTER:
                    ordner = "Burter";
                    break;
                case FighterData.HERCULE:
                    ordner = "Hercule";
                    break;
                case FighterData.CELLSUPER:
                    ordner = "Cell";
                    break;
                case FighterData.GOHANSSJ2:
                    ordner = "TeenGohan";
                    break;
                case FighterData.COOLER:
                    ordner = "Cooler";
                    break;
                case FighterData.GOHANKID:
                    ordner = "TeenGohan";
                    break;
                case FighterData.TRUNKSFUTURE:
                    ordner = "Trunks";
                    break;
                case 27:
                    ordner = "Ginyu";
            ...
            for (int h = 0; h < 11; h++) {
                ...
                sounds[i][h] = loadSound("resources/Music/Charactersounds/" + ordner + "/" + sound + ".wav");
            }
        }
